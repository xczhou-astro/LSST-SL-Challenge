...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks):
        ...
        self.fc_features = nn.Linear(512 * block.expansion, 256)
        self.batch_features = nn.BatchNorm1d(256)
    ...
    def forward(self, x):
        ...
        # Extract features
        features = F.relu(self.fc_features(out))
        features = self.batch_features(features)
